...
public class ArrayToClass {
  ...
  public static void main(String[] args) {
    ...
    PhyscData[] x = {
        new PhyscData("아이언맨", 160, 1.0),
        new PhyscData("슈퍼맨", 170, 1.5),
        new PhyscData("스파이더맨", 160, 0.3),
        new PhyscData("토르", 160, 0.5),
        new PhyscData("타노스", 160, 0.9),
        new PhyscData("록키", 160, 2.0),
    };
